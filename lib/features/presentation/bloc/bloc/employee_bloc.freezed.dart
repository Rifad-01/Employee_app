...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  fetchEmployees,TResult Function()?  creatingEmployees,required TResult orElse(),}) {final _that = this;
switch (_that) {
case FetchEmployees() when fetchEmployees != null:
return fetchEmployees();case CreatingEmployees() when creatingEmployees != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  fetchEmployees,required TResult Function()  creatingEmployees,}) {final _that = this;
switch (_that) {
case FetchEmployees():
return fetchEmployees();case CreatingEmployees():
return creatingEmployees();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  fetchEmployees,TResult? Function()?  creatingEmployees,}) {final _that = this;
switch (_that) {
case FetchEmployees() when fetchEmployees != null:
return fetchEmployees();case CreatingEmployees() when creatingEmployees != null:
return creatingEmployees();case _:
