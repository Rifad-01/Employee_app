...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( String email,  String password)?  login,TResult Function()?  logout,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Login() when login != null:
return login(_that.email,_that.password);case Logout() when logout != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( String email,  String password)  login,required TResult Function()  logout,}) {final _that = this;
switch (_that) {
case Login():
return login(_that.email,_that.password);case Logout():
return logout();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( String email,  String password)?  login,TResult? Function()?  logout,}) {final _that = this;
switch (_that) {
case Login() when login != null:
return login(_that.email,_that.password);case Logout() when logout != null:
return logout();case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Failure failure)?  errorState,TResult Function( String token)?  success,required TResult orElse(),}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Failure failure)  errorState,required TResult Function( String token)  success,}) {final _that = this;
switch (_that) {
case Initial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Failure failure)?  errorState,TResult? Function( String token)?  success,}) {final _that = this;
switch (_that) {
case Initial() when initial != null:
return initial();case Loading() when loading != null:
return loading();case ErrorState() when errorState != null:
...
@override
String toString() {
  return 'AuthState.errorState(failure: $failure)';
}
